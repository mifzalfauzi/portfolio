...
export default function ProjectCard({ title, description, image, link, demoLink, tags, year, details, images }: ProjectCardProps) {
  ...
  return (
    <>
      <Card className="overflow-hidden group transition-all duration-300 hover:shadow-lg dark:bg-black p-0 flex flex-col">
  {/* Image */}
  <div className="relative w-full h-[180px] overflow-hidden">
    ...
    />
    <div
      className="cursor-pointer absolute inset-0 bg-gradient-to-t from-background/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"
